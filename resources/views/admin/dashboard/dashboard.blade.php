                            ...
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="p-3 text-start">
                                            <li>
                                                Neow Female : <span class="totalFemaleNeowCount"></span>
                                            </li>
                                            <li>
                                                Neow Transgender : <span class="totalTransNeowCount"></span>
                                            </li>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="p-3 text-start">
                                            <li>
                                                Buddy Male : <span class="totalMaleBuddyCount"></span>
                                            </li>
                                            <li>
                                                Buddy Female : <span class="totalFemaleBuddyCount"></span>
                                            </li>
                                            <li>
                                                Buddy Transgender : <span class="totalTransBuddyCount"></span>
                                            </li>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card mb-3">
                                    <div class="card-body text-center">
                                        ...
                                        <div class="p-3 text-start">
                                            <li>
                                                Cycle-Explorer Male : <span class="totalMaleExplorerCount"></span>
                                            </li>
                                            <li>
                                                Cycle-Explorer Female : <span class="totalFemaleExplorerCount"></span>
                                            </li>
                                            <li>
                                                Cycle-Explorer Transgender : <span class="totalTransExplorerCount"></span>
                                            </li>
                                        </div>
                                    </div>
                                </div>

                                    ...
                                    <div class="form_box_info">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    <label for="firstname"
                                                        class="form-label"><strong>{{ trans('label.Name') }}</strong><span
                                        ...
                                        @if ($role->id != 1)
                                            <div class="prmission_box">
                                                <h5><strong>{{ trans('label.Permission') }}</strong><span
                                                        ...
                                                        <div class="accordion" id="accordionfourteen">
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="collapsefourteen"
                                                                    ...
                                                                    @foreach ($permission->slice(51, 4) as $value)
                                                                        <div class="accordion-body">
                                                                            <label>
                                                                                <input type="checkbox" name="permission[]"
                                                                                    value="{{ $value->id }}"
                                                                                    class="mr-3"
                                                                                    {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }}>
                                                                                @if ($value->name == 'festival.index')
                                                                                    {{ trans('label.view') }}
                                                                                @elseif($value->name == 'festival.create')
                                                                                    {{ trans('label.Add') }}
                                                                                @elseif($value->name == 'festival.edit')
                                                                                    {{ trans('label.Update') }}
                                                                                @else
                                                                                    {{ trans('label.Delete') }}
                                                                                @endif
                                                        ...
                                                        <div class="accordion" id="accordionfifteen">
                                                            <div class="accordion-item">
                                                                ...
                                                                <div id="collapsefifteen"
                                                                    ...
                                                                    @foreach ($permission->slice(55, 4) as $value)
                                                                        <div class="accordion-body">
                                                                            <label>
                                                                                <input type="checkbox" name="permission[]"
                                                                                    value="{{ $value->id }}"
                                                                                    class="mr-3"
                                                                                    {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }}>
                                                                                @if ($value->name == 'aap.posts.index')
                                                                                    {{ trans('label.view') }}
                                                                                @elseif($value->name == 'aap.posts.create')
                                                                                    {{ trans('label.Add') }}
                                                                                @elseif($value->name == 'aap.posts.edit')
                                                                                    {{ trans('label.Update') }}
                                                                                @else
                                                                                    {{ trans('label.Delete') }}
                                                                                @endif

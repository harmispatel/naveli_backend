                            ...
                            <div class="col-md-12 mt-3">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a href="{{ route('healthMix.edit', [encrypt($healthMix->id), 'en']) }}" class="nav-link {{ ($def_locale == 'en') ? 'active' : '' }}" id="pills-en-tab">English</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a href="{{ route('healthMix.edit', [encrypt($healthMix->id), 'hi']) }}" class="nav-link {{ ($def_locale == 'hi') ? 'active' : '' }}" id="pills-hi-tab">Hindi</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-md-12 mt-3">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <div class="form-group">
                                                                        <label for="title" class="form-label"><strong>{{ trans('label.healthtype') }}</strong>
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="description" min="0" id="description" rows="5"
                                                                            class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}">{{ $healthMix['description_'.$def_locale] }}</textarea>

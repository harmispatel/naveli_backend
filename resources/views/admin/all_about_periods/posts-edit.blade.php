                ...
                <div class="col-md-12 mt-3">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('aap.posts.edit', [encrypt($findedPost->id), 'en']) }}" class="nav-link {{ ($def_locale == 'en') ? 'active' : '' }}" id="pills-en-tab">English</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('aap.posts.edit', [encrypt($findedPost->id), 'hi']) }}" class="nav-link {{ ($def_locale == 'hi') ? 'active' : '' }}" id="pills-hi-tab">Hindi</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-12 mt-3">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="category_name"
                                                            ...
                                                            value="{{ old('category_name_' . $def_locale , $findedPost['category_name_' . $def_locale]) }}">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="descriptions[]" id="description" rows="5"
                                                            class="form-control {{ $errors->has('descriptions') ? 'is-invalid' : '' }}">{{ $allMediaStore[0]['description_' . $def_locale] ?? ''}}</textarea>
            ...
            <div class="row media-row">
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-group descriptions">
                        <label for="description" class="form-label"><strong>{{ trans('label.description') }}</strong>
                        <span class="text-uppercase">({{$def_locale}})</span>
                        </label>
                        <textarea name="descriptions[]" id="description" rows="5" class="form-control">${((media['description_' + defLocale]) ? media['description_' + defLocale] : '' )}</textarea>
                    </div>
                </div>
                <div class="col-md-12 text-end mb-3">
